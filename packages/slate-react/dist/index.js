...
var Editable = props => {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    if (newDomRange) {
      var isBackward = !!selection && slate.Range.isBackward(selection);
      var clonedRange = newDomRange.cloneRange();
  ...
  var onDOMSelectionChange = React.useCallback(throttle(() => {
    if (!readOnly && !state.isComposing && !state.isUpdatingSelection) {
      ...
      if (domRange && hasEditableTarget(editor, domRange.startContainer) && hasEditableTarget(editor, domRange.endContainer)) {
        ...
        if (domSelection && (domSelection.anchorNode === domRange.startContainer && domSelection.anchorOffset === domRange.startOffset && domSelection.focusNode === domRange.endContainer && domSelection.focusOffset === domRange.endOffset || domSelection.anchorNode === domRange.endContainer && domSelection.anchorOffset === domRange.endOffset && domSelection.focusNode === domRange.startContainer && domSelection.focusOffset === domRange.startOffset)) {
